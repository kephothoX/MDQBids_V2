  ...
  async WalletConn() {
    ...
    if (ethereum) {
      ...
      if (!Object.keys(snaps).includes(snapId)) {
          ...
          params: {
            ...
            request: {
              ...
              params: {
                network: 'testnet',
                assetType: 'TOKEN', 
                tokenId: `${await this._hederaFungibletoken.createFungibleToken(
                  ACCOUNT_ID,
                  SUPPLYKEY,
                  SUPPLYKEY,
        ...
        this._matSnackBar.open('Snap already installed', 'Dismiss');
      }


      /*console.log('Token IDs:  ', `${await this._hederaFungibletoken.createFungibleToken(
        ACCOUNT_ID,
        SUPPLYKEY,
        SUPPLYKEY,
        this._appService.client
      ...
      console.log('EVM Address:  ', window.sessionStorage.getItem('Account'));
        ...
        params: {
          ...
          request: {
            ...
            params: {
              network: 'testnet',
              mirrorNodeUrl: 'https://testnet.mirrornode.hedera.com',
              //accountId: '0.0.6501023',//window.sessionStorage.getItem('Account'),
            }
          }
        }
      });

      console.log('External Account:  ', externalAccountParams)
      console.log('Teste.......');

      console.log('ExternalAccountParams:  ', externalAccountParams);
      ...
      await window.ethereum.request({
        ...
        params: {
          ...
          request: {
            ...
            params: {
              network: 'testnet',
              tokenIds: [`${await this._hederaFungibletoken.createFungibleToken(
                ACCOUNT_ID,
                SUPPLYKEY,
                SUPPLYKEY,
                this._appService.client
